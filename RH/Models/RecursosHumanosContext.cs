...
public partial class RecursosHumanosContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Aspirante>(entity =>
        {
            ...
            entity.HasIndex(e => e.IdRegis, "IX_aspirante_id_regis");
        ...
        modelBuilder.Entity<Contratacion>(entity =>
        {
            ...
            entity.HasIndex(e => e.IdAsp, "IX_contratacion_id_asp");
        ...
        modelBuilder.Entity<Usuario>(entity =>
        {
            ...
            entity.HasIndex(e => e.IdUserNavigationIdRol, "IX_usuario_IdUserNavigationIdRol");
